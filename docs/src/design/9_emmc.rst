...
CLK and DAT0~DAT7+DS+CMD will be matched to 18.3917mm +- 3mm (21ps) on L3/L6 and 18.3917mm +- 5mm (25ps) on L8.

CLK and RST_N signals will be matched to 18.3917mm +- 14mm (100ps).
